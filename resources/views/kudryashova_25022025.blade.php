    ...
    <div class="mx-auto max-w-7xl lg:grid lg:grid-cols-12 lg:gap-x-8 lg:px-8">
        <div class="px-6 pb-24 pt-10 sm:pb-32 lg:col-span-7 lg:px-0 lg:pb-56 lg:pt-48 xl:col-span-6">
          <div class="mx-auto max-w-2xl lg:mx-0">
              ...
              <h1 class="mt-24 text-3xl font-bold tracking-tight text-gray-900 sm:mt-10 sm:text-6xl">Арт-терапия в работе с детьми в норме и при ОВЗ: направления, преимущества, специфика используемых методик</h1>
              <p class="mt-6 text-lg leading-6 text-gray-600">доктор филологических наук Александра Артуровна Кудряшова</p>
        ...
        <div class="relative lg:col-span-5 lg:-mr-8 xl:absolute xl:inset-0 xl:left-1/2 xl:mr-0">
            <img class="aspect-[3/2] w-full bg-gray-50 object-cover lg:absolute lg:inset-0 lg:aspect-auto lg:h-full" src="{{ asset('img/hero_kudryashova_25022025.jpg') }}" alt="">
        </div>
    </div>
</div>
...
<div class="bg-stone-100 py-24 sm:py-32"  id='dopobr'{{-- style="height: 100vh;" --}}>
    <div class="mx-auto max-w-7xl px-6 lg:px-8">
        <div class="mx-auto max-w-2xl lg:mx-0">
            <h2 class="text-3xl font-bold tracking-tight text-mona-lisa-700 sm:text-4xl">Арт-терапия для детей</h2>
            <p class="mt-1 text-lg leading-8 text-gray-600">Вебинар. 25 февраля 2025 года.</p>
            ...
            <dl class="grid max-w-xl grid-cols-1 gap-x-8 gap-y-16 lg:max-w-none lg:grid-cols-3">
                <div class="flex flex-col">
                    ...
                    <dd class="mt-1 flex flex-auto flex-col text-base leading-7 text-gray-600">
                        <p class="flex-auto">Вы узнаете, с какими проблемами детей можно работать, каким методам отдать предпочтение, как грамотно проводить терапию, познакомитесь с наиболее эффективными техниками арт-терапии в работе с детьми с ограниченными возможностями здоровья. </p>
                    </dd>
                </div>
                <div class="flex flex-col">
                  <dt class="text-base font-semibold leading-7 text-gray-900">
                  ...
                  <dd class="mt-1 flex flex-auto flex-col text-base leading-7 text-gray-600">
                      <p class="flex-auto">Психологи, педагоги, специалисты, работающие с детьми, а также все, кого интересуют механизмы художественной коммуникации и вопросы, связанные с психологией творчества, открытием креативности и ресурсных зон в жизни. <strong class="text-mona-lisa-600">Приготовьте альбом или листы формата А4, краски, фломастеры</strong>.</p>
                  </dd>
                </div>
                <div class="flex flex-col">
                  <dt class="text-base font-semibold leading-7 text-gray-900">
                  ...
                  <dd class="mt-1 flex flex-auto flex-col text-base leading-7 text-gray-600">
                      <p class="flex-auto">Участники вебинара познакомятся с современными направлениями в арт-терапии, раскроют ключевые механизмы стратегий арт-терапевтических практик и их ресурсы, приобретут практический опыт использования арт-технологий. Все слушатели получат именные электронные сертификаты.</p>
                  </dd>
                </div>
            </dl>
        </div>
...
<div id="price-webinar">
    <three-tiers-price-kudryashova-25022025/>
</div>

<div id="with-large-avatar">
    <with-large-avatar-kudryashova/>
</div>
