          ...
          <div class="mx-auto max-w-2xl lg:mx-0">
              <div class="hidden sm:mt-32 sm:flex lg:mt-16">
                  <div class="relative rounded-full px-3 py-1 text-sm leading-6 text-gray-500 ring-1 ring-gray-900/10 hover:ring-gray-900/20">
                      Обучающий курс <strong class="text-amber-700">для врачей</strong> 
                  </div>
              </div>
              <h1 class="mt-24 text-3xl font-bold tracking-tight text-gray-900 sm:mt-10 sm:text-6xl">Генетика в неврологии для начинающих специалистов</h1>
              <p class="mt-6 text-lg leading-6 text-gray-600">кандидат медицинских наук, врач Сергей Александрович Курбатов</p>
              <div class="mt-10 flex items-center gap-x-6">
                  <a href="#price-webinar" class="rounded-md bg-amber-600 px-3.5 py-2.5 text-sm font-semibold text-white shadow-sm hover:bg-amber-600 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-purple-800">Записаться</a>
                  <a href="#with-large-avatar" class="text-sm font-semibold leading-6 text-gray-900">Узнать больше...</a>
              </div>
          </div>
        </div>
        <div class="relative lg:col-span-5 lg:-mr-8 xl:absolute xl:inset-0 xl:left-1/2 xl:mr-0">
            <img class="aspect-[3/2] w-full bg-gray-50 object-cover lg:absolute lg:inset-0 lg:aspect-auto lg:h-full" src="{{ asset('img/hero_kurbatov.jpg') }}" alt="">
        </div>
    </div>
</div>
...
<div class="bg-stone-100 py-24 sm:py-32"  id='dopobr'{{-- style="height: 100vh;" --}}>
    <div class="mx-auto max-w-7xl px-6 lg:px-8">
        <div class="mx-auto max-w-2xl lg:mx-0">
            <h2 class="text-3xl font-bold tracking-tight text-amber-700 sm:text-4xl">Введение в нейрогенетику</h2>
            ...
            <dl class="grid max-w-xl grid-cols-1 gap-x-8 gap-y-16 lg:max-w-none lg:grid-cols-3">
                <div class="flex flex-col">
                    ...
                    <dd class="mt-1 flex flex-auto flex-col text-base leading-7 text-gray-600">
                        <p class="flex-auto">Базовые понятия нейрогенетики. Классификация наследственных заболеваний, варианты их передачи, методы диагностики. Чтение и интерпретация молекулярно-генетических заключений. Генетическая гетерогенность наследственных заболеваний.</p>
                    </dd>
                </div>
                <div class="flex flex-col">
                  <dt class="text-base font-semibold leading-7 text-gray-900">
                  ...
                  <dd class="mt-1 flex flex-auto flex-col text-base leading-7 text-gray-600">
                      <p class="flex-auto">Врачи: неврологи, педиатры, генетики. Студенты медицинских факультетов высших учебных заведений.</p>
                  </dd>
                </div>
                <div class="flex flex-col">
                  <dt class="text-base font-semibold leading-7 text-gray-900">
                  ...
                  <dd class="mt-1 flex flex-auto flex-col text-base leading-7 text-gray-600">
                      <p class="flex-auto">Слушатели получат систематизированное, научно обоснованное и применимое на практике представление о наследственных заболеваниях в неврологии.</p>
                  </dd>
                </div>
            </dl>
        </div>
