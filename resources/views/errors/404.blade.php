...
<div class="h-0 min-h-[768px] bg-white" style="padding-top: 5rem; padding-bottom: 5rem">
    ...
    <main class="grid min-h-full place-items-center bg-white px-6 py-32 sm:py-32 lg:px-8">
        <div class="text-center">
                ...
                <p class="mt-6 text-base leading-7 text-gray-600">Извините, мы не смогли найти нужную страницу.</p>
            <div class="mt-10 flex items-center justify-center gap-x-6">
                <a href="/" class="rounded-md bg-red-600 px-3.5 py-2.5 text-sm font-semibold text-white shadow-sm hover:bg-red-700 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-600">Вернуться на главную</a>
