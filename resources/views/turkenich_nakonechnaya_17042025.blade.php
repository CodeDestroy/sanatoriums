...
<div class="relative bg-white" {{-- style="height: 100vh;" --}} >
    <div class="mx-auto max-w-7xl lg:grid lg:grid-cols-12 lg:gap-x-8 lg:px-8">
          ...
          <div class="mx-auto max-w-2xl lg:mx-0">
              <div class="hidden sm:mt-32 sm:flex lg:mt-16">
                  <div class="relative rounded-full px-3 py-1 text-sm leading-6 text-gray-500 ring-1 ring-gray-900/10 hover:ring-gray-900/20">
                      Вебинар <strong class="text-mona-lisa-600">для родителей и специалистов</strong> 
                  </div>
              </div>
              <h1 class="mt-24 text-3xl font-bold tracking-tight text-gray-900 sm:mt-10 sm:text-6xl">Нейростимуляция когнитивной  сферы и эмоционально - коммуникативного поведения детей с особенностями развития</h1>
              <p class="mt-6 text-lg leading-6 text-gray-600">психологи Елена Владимировна Туркенич и Наталия Тимофеевна Наконечная
              </p>
        ...
        <div class="relative lg:col-span-5 lg:-mr-8 xl:absolute xl:inset-0 xl:left-1/2 xl:mr-0">
            <img class="aspect-[3/2] w-full bg-gray-50 object-cover lg:absolute lg:inset-0 lg:aspect-auto lg:h-full" src="{{ asset('img/hero_turkenich_nakonechnaya_17042025.jpg') }}" alt="">
        </div>
    </div>
</div>
...
<div class="bg-stone-100 py-24 sm:py-32"  id='dopobr'{{-- style="height: 100vh;" --}}>
    <div class="mx-auto max-w-7xl px-6 lg:px-8">
        <div class="mx-auto max-w-2xl lg:mx-0">
            <h2 class="text-3xl font-bold tracking-tight text-mona-lisa-700 sm:text-4xl">Двухдневный вебинар-практикум</h2>
            <p class="mt-1 text-lg leading-8 text-gray-600">17 апреля 2025 года с 19-00 до 21-15</p>
            <p class="mt-1 text-lg leading-8 text-gray-600">24 апреля 2025 года с 19-00 до 21-15</p>
            <p class="mt-0 text-lg leading-8 text-gray-600"><strong>6 академических часов</strong></p>
            ...
            <dl class="grid max-w-xl grid-cols-1 gap-x-8 gap-y-16 lg:max-w-none lg:grid-cols-3">
                <div class="flex flex-col">
                    ...
                    <dd class="mt-1 flex flex-auto flex-col text-base leading-7 text-gray-600">
                        <p class="flex-auto">Вебинар посвящен оригинальной комплексной методике стимуляции созревания нервной системы ребёнка, благодаря которой становится возможным формирование у детей способностей к обучению и коммуникации посредством: повышения концентрации внимания, улучшения речи и памяти, усидчивости, сопротивляемости к стрессам, снижения чрезмерного эмоционального возбуждения.
                        </p>
                    </dd>
                </div>
                <div class="flex flex-col">
                  ...
                  <dd class="mt-1 flex flex-auto flex-col text-base leading-7 text-gray-600">
                      <p class="flex-auto">Нейропсихологи и психологи, специализирующиеся на взаимоотношениях родителей и детей, комплексной коррекции обучения и поведения. Родители, которых беспокоят вопросы развития детей и коммуникации с ними. </p>
                  </dd>
                </div>
                <div class="flex flex-col">
                  <dt class="text-base font-semibold leading-7 text-gray-900">
                  ...
                  <dd class="mt-1 flex flex-auto flex-col text-base leading-7 text-gray-600">
                      <p class="flex-auto">Большое место в методике занимает работа с родителями, которые научатся грамотно участвовать в полноценной коррекционной терапии своих детей. Все слушатели получат именные электронные сертификаты.</p>
                  </dd>
                </div>
            </dl>
        </div>
...
<div id="price-webinar">
    <three-tiers-price-turkenich-17042025/>
</div>

<div id="with-large-avatar">
    <with-large-avatar-turkenich/>
</div>

<div id="content">
    <content-turkenich-17042025/>
</div>
