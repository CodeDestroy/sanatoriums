    ...
    @if ($freq == 100)
        <div class="flex justify-center items-center bg-gray-100" style="height: 80vh">
            <div class="w-full max-w-md p-6 bg-white rounded-lg shadow-md">
                <h2 class="text-2xl font-semibold text-gray-800 text-center mb-4">Вебинар 02.03.2025 <br>11-00 - 14-00</h2>
                <p class="text-xl font-semibold text-gray-700 text-center mb-4">медицинский психолог Г.А. Третьякова</p>
                <p class="text-md font-semibold text-gray-700 text-center mb-4">"Детско-родительские отношения. Методы диагностики и коррекции"</p>
                ...
                <div class="text-center flex justify-center">
                    <script type="text/javascript" src="https://auth.robokassa.ru/Merchant/PaymentForm/FormSS.js?EncodedInvoiceId=ZDbuXGjzr0e2GdsGtJEFeQ"></script>
                </div>
