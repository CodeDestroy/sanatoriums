...
<div class="relative bg-white" {{-- style="height: 100vh;" --}} >
    <div class="mx-auto max-w-7xl lg:grid lg:grid-cols-12 lg:gap-x-8 lg:px-8">
        ...
        <div class="relative lg:col-span-5 lg:-mr-8 xl:absolute xl:inset-0 xl:left-1/2 xl:mr-0">
            <img class="aspect-[3/2] w-full bg-gray-50 object-cover lg:absolute lg:inset-0 lg:aspect-auto lg:h-full" src="{{ asset('img/hero_tretyakova_02032025.jpg') }}" alt="">
        </div>
    </div>
</div>
...
<div class="bg-stone-100 py-24 sm:py-32"  id='dopobr'{{-- style="height: 100vh;" --}}>
    <div class="mx-auto max-w-7xl px-6 lg:px-8">
        <div class="mx-auto max-w-2xl lg:mx-0">
            <h2 class="text-3xl font-bold tracking-tight text-mona-lisa-700 sm:text-4xl">Лекционно-практический вебинар</h2>
            <p class="mt-1 text-lg leading-8 text-gray-600">02 марта 2025 года.</p>
            <p class="mt-0 text-lg leading-8 text-gray-600"><strong>4 академических часа:</strong> с 11-00 до 14-00</p>
            <p class="mt-0 text-lg leading-8 text-gray-600 mt-2">мини-лекция, упражнения, обсуждение, ответы на вопросы</p>
        </div>
            ...
            <dl class="grid max-w-xl grid-cols-1 gap-x-8 gap-y-16 lg:max-w-none lg:grid-cols-3">
                <div class="flex flex-col">
                    ...
                    <dd class="mt-1 flex flex-auto flex-col text-base leading-7 text-gray-600">
                        <p class="flex-auto">Почему дети бывают невыносимы? Как их плохое поведение связано с нарушенными детско-родительскими отношениями?  Вы узнаете, что необходимо знать и уметь родителю, чтобы ребенок его слушал и слышал. Вы поймете, какие ошибки совершаете и почему некоторые фразы не воспринимаются ребенком и вредят отношениям с ним. Обсудим простые и понятные техники общения с детьми.</p>
                    </dd>
                </div>
                <div class="flex flex-col">
                  <dt class="text-base font-semibold leading-7 text-gray-900">
                  ...
                  <dd class="mt-1 flex flex-auto flex-col text-base leading-7 text-gray-600">
                      <p class="flex-auto">Родители, которых беспокоят вопросы взаимодействия с детьми. Психологи, педагоги, дефектологи, врачи общего профиля и педиатры.</p>
                  </dd>
                </div>
                <div class="flex flex-col">
                  <dt class="text-base font-semibold leading-7 text-gray-900">
                  ...
                  <dd class="mt-1 flex flex-auto flex-col text-base leading-7 text-gray-600">
                      <p class="flex-auto"> Участники вебинара разберут реальные примеры распространенных конфликтов, обозначат причины их возникновения, найдут оптимальные пути их решения, узнают, как взаимодействовать с невыносимыми детьми, обсудят актуальные вопросы детско-родительских отношений. Все слушатели получат именные электронные сертификаты.</p>
                  </dd>
                </div>
            </dl>
        </div>
...
<div id="price-webinar">
    <three-tiers-price-tretyakova-02032025/>
</div>
