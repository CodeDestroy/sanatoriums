    ...
    <div class="mx-auto max-w-7xl mt-12  px-6 lg:px-8">
        <dl class="max-w-7xl text-gray-900 divide-y divide-gray-200 dark:text-white dark:divide-gray-700">
            <div class="flex flex-col pb-3">
                <dt class=" mb-1 text-lg font-semibold text-gray-700 ">Для чего нужна санаторно-курортная карта? </dt>
                <dd class="text-gray-600 md:text-lg dark:text-gray-400">Карта понадобится при поступлении в оздоровительное учреждение для проведения корректного лечения. В документе содержится информация о результатах обследований, перенесенных заболеваниях, а также о наличии показаний и/или противопоказаний к лечению.
                    На основании санаторно-курортной карты отдыхающим назначаются те или иные оздоровительные процедуры.</dd>
            </div>
            <div class="flex flex-col py-3">
                
                    <dd class="text-gray-600 md:text-lg dark:text-gray-400">Друзья, если вы собрались в санаторий, то вам никак не обойтись без санаторно-курортной карты. 
                        Оформить ее быстро и просто можно в медицинском центре «Здоровый ребенок» в Воронеже.</dd>
            </div>
            <div class="flex flex-col pt-3">
                
                    <dd class="text-gray-600 md:text-lg dark:text-gray-400"> Здесь можно сдать все необходимые анализы, записаться на прием к специалисту, оформить и получить санаторно-курортную карту без лишнего стресса. 
                        А если вы живете в другом городе и не можете приехать лично, то оформить карту можно в онлайн формате и заказать ее доставку на дом курьером.</dd>
            </div>
            <div class="flex flex-col pt-3">
                
                    <dd class="text-gray-600 md:text-lg dark:text-gray-400">Все подробности и детали оформления санаторно-курортной карты можно уточнить по телефону 8-963-561-83-95.  
                        В медицинском центре «Здоровый ребенок» постарались сделать процесс оформления санаторно-курортной карты максимально удобным и комфортным, чтобы вы могли спокойно готовиться к отдых</dd>
            </div>
        </dl>
