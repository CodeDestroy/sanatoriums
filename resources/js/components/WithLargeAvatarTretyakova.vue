      ...
      <div class="relative mx-auto max-w-2xl py-24 sm:py-16 lg:max-w-4xl">
        ...
        <figure class="grid grid-cols-1 items-center gap-x-6 gap-y-8 lg:gap-x-10">
          <div class="col-span-2 w-64 lg:col-end-1 lg:row-span-2 lg:w-72">
            <img class="rounded-xl bg-indigo-50 lg:rounded-3xl" src="img/tretyakova_list.jpg" alt="" />
          </div>
          <figcaption class="text-base lg:col-start-1 lg:row-start-1">
            <div class="text-lg font-semibold text-mona-lisa-600 sm:text-2xl">Галина Анатольевна Третьякова</div>
            <div class="mt-1 text-gray-500">медицинский психолог, преподаватель Регионального Учебного Центра НМИЦ ПН им. В.М. Бехтерева</div>
          </figcaption>
          <div class="relative col-span-2 lg:col-start-1 lg:row-start-2">
            ...
            <blockquote class="text-gray-900">
              <p>Активный участник семинаров, тренингов и лекционных выездных циклов обучения по медицинской (клинической) психологии детского возраста.</p>
              <p class="font-semibold py-4">Область основных научно-практических интересов:</p>
              <ul class="marker:text-mona-lisa-600 list-disc ps-4">
                <li>задержки темпа психического развития, умственная отсталость у детей и подростков</li>
                <li>психологическое консультирование</li>
                <li>групповая и индивидуальная психологическая коррекция</li>
                <li>детско-родительские отношения</li>
                <li>психологическое сопровождение детей и подростков с особенностями поведения и развития</li>
                <li>сказкотерапия</li>
                <li>БОС-терапия</li>
                <li>прикладной анализ поведения</li>
                <li>семейное консультирование</li>
                <li>развитие личностного потенциала</li>
              </ul>
            </blockquote>
          </div>
        </figure>
