<template>
  <div class="bg-gray-900">
    <div class="relative isolate overflow-hidden pt-14">
      <img src="img/hero_bg_zr_tour.jpg" alt="" class="absolute inset-0 -z-10 h-full w-full object-cover opacity-60" />
      ...
      <div class="mx-auto max-w-2xl py-32 sm:py-48 lg:py-56">
        ...
        <div class="text-center">
          <h1 class="text-4xl font-bold tracking-tight text-white sm:text-6xl">Отдых, который лечит</h1>
          <p class="mt-6 text-lg leading-8 text-gray-300">с заботой о Вашем здоровье</p>
          <!--
