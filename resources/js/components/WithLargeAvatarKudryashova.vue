      ...
      <div class="relative mx-auto max-w-2xl py-24 sm:py-16 lg:max-w-4xl">
        ...
        <figure class="grid grid-cols-1 items-center gap-x-6 gap-y-8 lg:gap-x-10">
          <div class="col-span-2 w-64 lg:col-end-1 lg:row-span-2 lg:w-72">
            <img class="rounded-xl bg-indigo-50 lg:rounded-3xl" src="img/kudryashova_list.jpg" alt="" />
          </div>
          <figcaption class="text-base lg:col-start-1 lg:row-start-1">
            <div class="text-lg font-semibold text-mona-lisa-600 sm:text-2xl">Александра Артуровна Кудряшова</div>
            <div class="mt-1 text-gray-500">доктор филологических наук, доцент</div>
          </figcaption>
          <div class="relative col-span-2 lg:col-start-1 lg:row-start-2">
            ...
            <blockquote class="text-gray-900">
              <p>Автор оригинальной арт-терапевтической методики</p>
              <p>ведущий эксперт Государственного автономного образовательного учреждения дополнительного профессионального образования города Москвы "Московский центр качества образования"</p>
            </blockquote>
          </div>
        </figure>
      </div>
